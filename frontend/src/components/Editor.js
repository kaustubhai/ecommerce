  ...
  return (
    <Row className="d-flex justify-content-center align-items-center">
      ...
      <Button
        ...
        className={
          editor.isActive("heading", { level: 1 }) ? "bg-white text-dark" : ""
        }
      >
        h1
      </Button>
      <Button
        ...
        className={
          editor.isActive("heading", { level: 2 }) ? "bg-white text-dark" : ""
        }
      >
        h2
      </Button>
      <Button
        ...
        className={
          editor.isActive("heading", { level: 3 }) ? "bg-white text-dark" : ""
        }
      >
        h3
      </Button>
      <Button
        ...
        className={
          editor.isActive("heading", { level: 4 }) ? "bg-white text-dark" : ""
        }
      >
        h4
      </Button>
      <Button
        ...
        className={
          editor.isActive("heading", { level: 5 }) ? "bg-white text-dark" : ""
        }
      >
        h5
      </Button>
      <Button
        ...
        className={
          editor.isActive("heading", { level: 6 }) ? "bg-white text-dark" : ""
        }
      >
        h6
      </Button>
      ...
      <Button
        ...
        className={
          editor.isActive({ textAlign: "left" }) ? "bg-white text-dark" : ""
        }
      >
      ...
      <Button
        ...
        className={
          editor.isActive({ textAlign: "center" }) ? "bg-white text-dark" : ""
        }
      >
      ...
      <Button
        ...
        className={
          editor.isActive({ textAlign: "right" }) ? "bg-white text-dark" : ""
        }
      >
      ...
      <Button
        ...
        className={
          editor.isActive({ textAlign: "justify" }) ? "bg-white text-dark" : ""
        }
      >
