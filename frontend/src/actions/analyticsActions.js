...
export const getNetSaleThisMonth = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      "/api/analytics/net-sale-this-month",
      config
    );
    dispatch({
      type: NET_SALE_MO,
...
export const getOutOfStockProducts = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      "/api/analytics/out-of-stock-products",
      config
    );
    dispatch({
...
export const getLowInStockProducts = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      "/api/analytics/low-in-stock-products",
      config
    );
    dispatch({
...
export const getNewUserOnboardedThisMonth =
  () => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.get(
        "/api/analytics/new-user-onboarded-this-month",
        config
      );
      dispatch({
...
export const getProcessingOrderCount = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      "/api/analytics/processing-order-count",
      config
    );
    dispatch({
